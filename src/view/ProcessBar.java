 ...
 * @author LoiDinh
 */
public class ProcessBar extends javax.swing.JDialog {

    /**
     * Creates new form ProcessBar
     */
    
    public ProcessBar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagev2/vlupmg.png"))); // NOI18N

        jProgressBar1.setBackground(new java.awt.Color(58, 100, 166));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProcessBar dialog = new ProcessBar(new javax.swing.JFrame(), true);
